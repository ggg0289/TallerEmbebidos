...
NOTA: Pasando parámetros con arreglos de colas y mutex globales.
      El mensaje es los elementos ordenados y sus índices.
      La animación se simplificó.
...
pthread_mutex_t mutexE = PTHREAD_MUTEX_INITIALIZER;          //Mutex para hacer experomentos con la parte gráfica.
...
int main()
{
    ...
    initwindow(getmaxwidth(), 500, "ALGORITMOS DE ORDENAMIENTO - EJECUCIÓN");  //Iniciar graphics.
