...
//Cambios con respecto a 4_1: función de pausa, error en los palillos, cambios para 6 filósofos.
...
#define LEFT (phnum + 5) % N    //Filósofo inmediatamente a la izquierda.
#define RIGHT (phnum + 1) % N   //Filósofo inmediatamente a la derecha.

int state[N];                           //Arreglo para el estado de cada filósofo.
int phil[N] = { 0, 1, 2, 3, 4, 5 };     //Arreglo con la identificación de cada filósofo.
