...
//Cambios con respecto a 4_3: límite de comidas para ls filósfos.
...
#define MAXCOMIDAS 10               //Número máximo de comidas por filósofo.

int estado[NF];                             //Arreglo para el estado de cada filósofo.
int comidas[NF] = { 0, 0, 0, 0, 0, 0 };     //Arreglo para el numero de comidas de ada filósofo.
